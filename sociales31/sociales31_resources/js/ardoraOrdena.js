...
} else {$("#ardoraQuest").html(vHtml+"<img alt='Play' id='playSound' class='imaLeft' src='sociales31_resources/media/sound.png' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
